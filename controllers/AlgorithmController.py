...
class AlgorithmController:
    '''
    Description: cette classe est le controleur d'algorthime, qui réalise à chercher la meilleur solution d'affection
    Attributs:
    ...
    def run(self, iterationTimes):
        ...
        while iterationCounter < iterationTimes:
            ...
            averageQualityOfSolutionForEachIterationList.append(self.calculateAverageSolutionQualityForEachIteration
                                                                (qualityOfSolutionForOneIterationList))
    ...
    def chooseCare(self, buidlingToAllocateIndex, buildingToAllocateList, careToFillList, isCareFullList, solution):
        ...
        while j < len(careToFillList):
            ...
            if self.instance.buildingList[buidlingToAllocateIndex].population <= self.instance.careList[j].capacity and \
