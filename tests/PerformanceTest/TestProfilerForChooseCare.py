...
'''
Description:
    Ce fichier est le script du test de la performance de sélection de care avec l'outil "profile"
...
class TestProfilerForChooseCare:
    '''
    Description:
        Cette classe est pour tester la sélection de cares en utilisant l'outil "Profile"
    ...
    def test_chooseCare(self):
        '''
        Description:
            Cette méthode est pour tester la fonction de sélection de cares
        ...
        # le batiment à affecter est en l'indice 1
        buidlingToAllocateIndex = 1

        pac = ProfilerAlgorithmController(instance, 3000)

        # initialiser la liste de solution
        solution.solutionArray = [-1, -1, -1, -1, -1, -1, -1]
        # initialiser la liste qui marque si le care est plein ou pas
        ...
        pac.chooseCare(buidlingToAllocateIndex, buildingToAllocateList,careToFillList, isCareFullList, solution)


if __name__ == '__main__':
    profilerForChooseCare = TestProfilerForChooseCare()
    profilerForChooseCare.test_chooseCare()