...
class TestAlgorithmController(unittest.TestCase):
    ...
    def test_objectiveFunctionF(self):
        ...
        distance = [[10,20,30,15,5,20,30], [30,20,15,20,15,10,5], [20,30,10,25,5,20,10], [40,10,5,30,25,15,10], [30,20,30,5,10,15,20]]
        instance = InstanceModel()
        instance.distanceMatrix = distance
        instance.careList = [CareModel(),CareModel(),CareModel(), CareModel(),CareModel(),CareModel(),CareModel()]
        i = 0
        while i < 5:
            building = BuildingModel()
            building.population = (i + 1) * 2
            instance.buildingList.append(building)
            i += 1
        ac = AlgorithmController(instance, 3000)
        self.assertTrue(ac.objectiveFunctionF(solution) == 150)
    ...
    def test_objectiveFunctionG(self):
        ...
        while i < 5:
            ...
            i += 1
        ac = AlgorithmController(instance, 3000)
        self.assertTrue(ac.objectiveFunctionG(solution) == 30)
    ...
    def test_chooseCare(self):
        ...
        self.assertTrue(careToFillIndex == 6)
    ...
    def test_run(self):
        ...
        self.assertListEqual(ac.bestSolution.solutionArray, [4,5,6,-1,3])
